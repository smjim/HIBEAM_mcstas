...
def generate_VB_array_bladeFocused(length, thickness, zvb, zdet, ydet, vy, source_pos_file):
...
def generate_VB_focused_blades(VB_pos, zdet, det_pos, VB_length, VB_thickness, vx, vy, hx, hy, source_pos_file):
	...
	x_vals_h, angles_h = generate_VB_array_bladeFocused(length, thickness, zvb, zdet, xdet, hx, source_pos_file)
